...
enforces one live DocuForge process per durable storage root. Batch admission is reserved before
workspace preparation and bounds preparing, queued, and active execution. Execution remains
single-process.
